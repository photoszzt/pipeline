...
nodes.append(Node(name="grayscale", stage="grayscale", delivery_function=None, config=Config(framesperchunk=None, chunklimit=None, duration=None, nworkers=None, nsockets=None, outdir=None), lambda_function=None))
...
parlink_grayscale["streams"]=streams
with open('parlink_grayscale.json', 'w') as f:
    json.dump(parlink_grayscale, f, indent=2, cls=Encoder)
